...
describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    const tokenA = new Token(ChainId.MOONBEAM_TEST, '0x0000000000000000000000000000000000000001', 18,'t1','t1')
    const tokenB = new Token(ChainId.MOONBEAM_TEST, '0x0000000000000000000000000000000000000002', 18,'t2','t2')
  ...
  it('getLiquidityMinted:!0', async () => {
    const tokenA = new Token(ChainId.MOONBEAM_TEST, '0x0000000000000000000000000000000000000001', 18, 't1','t2')
    const tokenB = new Token(ChainId.MOONBEAM_TEST, '0x0000000000000000000000000000000000000002', 18, 't2','t2')
  ...
  it('getLiquidityValue:feeOn', async () => {
    const tokenA = new Token(ChainId.MOONBEAM_TEST, '0x0000000000000000000000000000000000000001', 18, 't0','t0')
    const tokenB = new Token(ChainId.MOONBEAM_TEST, '0x0000000000000000000000000000000000000002', 18, 't1','t1' )
    const pair = new Pair(new TokenAmount(tokenA, '1000'), new TokenAmount(tokenB, '1000'))

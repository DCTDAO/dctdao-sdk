...
describe('Trade', () => {
  ...
  const token2 = new Token(chainId, '0x0000000000000000000000000000000000000003', 18, 't2','t2')
  const token3 = new Token(chainId, '0x0000000000000000000000000000000000000004', 18, 't3','t3')
